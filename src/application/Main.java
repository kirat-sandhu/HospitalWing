...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		//	VBox managerLoader = loader.load(new FileInputStream("src/application/ManagerGUI.fxml"));	

		//	VBox nurseLoader = loader.load(new FileInputStream("src/application/ManagerGUI.fxml"));	
	...
	public static void main(String[] args) {
		launch(args);
		Shift m1 = new Shift(new Date(3444444),new Date(60004444));
